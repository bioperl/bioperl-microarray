...
ppd :
	...
	$(NOECHO) $(ECHO) '    <ABSTRACT>Bioperl Toolkit - Addendum for microarray data</ABSTRACT>' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  Bio/Expression/MicroarrayI.pm $(INST_LIB)/Bio/Expression/MicroarrayI.pm \
	  Bio/Expression/Microarray/Affymetrix/Mas50Data.pm $(INST_LIB)/Bio/Expression/Microarray/Affymetrix/Mas50Data.pm \
	  Bio/Expression/MicroarrayIO/dchipxls.pm $(INST_LIB)/Bio/Expression/MicroarrayIO/dchipxls.pm \
	  Bio/Expression/Microarray/Affymetrix/dChipXLS.pm $(INST_LIB)/Bio/Expression/Microarray/Affymetrix/dChipXLS.pm \
	  Bio/Expression/MicroarrayIO/mas50txt.pm $(INST_LIB)/Bio/Expression/MicroarrayIO/mas50txt.pm \
	  Bio/Expression/Microarray/Affymetrix/dChipArray.pm $(INST_LIB)/Bio/Expression/Microarray/Affymetrix/dChipArray.pm \
	  Bio/Expression/MicroarrayIO/affymetrix.pm $(INST_LIB)/Bio/Expression/MicroarrayIO/affymetrix.pm \
	  Bio/Expression/Microarray/Affymetrix/Array.pm $(INST_LIB)/Bio/Expression/Microarray/Affymetrix/Array.pm \
	  Bio/Expression/Microarray/Affymetrix/CelArray.pm $(INST_LIB)/Bio/Expression/Microarray/Affymetrix/CelArray.pm \
	  Bio/Expression/Microarray/FeatureI.pm $(INST_LIB)/Bio/Expression/Microarray/FeatureI.pm \
	  Bio/Expression/Microarray/Affymetrix/Data.pm $(INST_LIB)/Bio/Expression/Microarray/Affymetrix/Data.pm \
	  Bio/Expression/Microarray/DataI.pm $(INST_LIB)/Bio/Expression/Microarray/DataI.pm \
	  Bio/Expression/Microarray/Affymetrix/Feature.pm $(INST_LIB)/Bio/Expression/Microarray/Affymetrix/Feature.pm \
	  Bio/Expression/Microarray/Affymetrix/Changes.txt $(INST_LIB)/Bio/Expression/Microarray/Affymetrix/Changes.txt \
	  Bio/Expression/Microarray/ArrayI.pm $(INST_LIB)/Bio/Expression/Microarray/ArrayI.pm \
	  Bio/Expression/Microarray/Affymetrix/ArrayDesign.pm $(INST_LIB)/Bio/Expression/Microarray/Affymetrix/ArrayDesign.pm \
	  Bio/Expression/MicroarrayIO.pm $(INST_LIB)/Bio/Expression/MicroarrayIO.pm \
	  Bio/Expression/Microarray/Affymetrix/Mas50TxtArray.pm $(INST_LIB)/Bio/Expression/Microarray/Affymetrix/Mas50TxtArray.pm 
...
affy_u133a_txt \
affy_u95av2_cel \
affy_u95av2_cel_stream \
'
test_affy_u133a_cel :: pure_all
	PERL_DL_NONLAZY=1 $(FULLPERL) -I$(INST_ARCHLIB) -I$(INST_LIB) -I$(PERL_ARCHLIB) -I$(PERL_LIB) -e 'use Test::Harness qw(&runtests $$verbose); $$verbose=$(TEST_VERBOSE); runtests @ARGV;' t/affy_u133a_cel.t
test_affy_u133a_stream :: pure_all
	PERL_DL_NONLAZY=1 $(FULLPERL) -I$(INST_ARCHLIB) -I$(INST_LIB) -I$(PERL_ARCHLIB) -I$(PERL_LIB) -e 'use Test::Harness qw(&runtests $$verbose); $$verbose=$(TEST_VERBOSE); runtests @ARGV;' t/affy_u133a_stream.t
test_affy_u133a_txt :: pure_all
	PERL_DL_NONLAZY=1 $(FULLPERL) -I$(INST_ARCHLIB) -I$(INST_LIB) -I$(PERL_ARCHLIB) -I$(PERL_LIB) -e 'use Test::Harness qw(&runtests $$verbose); $$verbose=$(TEST_VERBOSE); runtests @ARGV;' t/affy_u133a_txt.t
test_affy_u95av2_cel :: pure_all
	PERL_DL_NONLAZY=1 $(FULLPERL) -I$(INST_ARCHLIB) -I$(INST_LIB) -I$(PERL_ARCHLIB) -I$(PERL_LIB) -e 'use Test::Harness qw(&runtests $$verbose); $$verbose=$(TEST_VERBOSE); runtests @ARGV;' t/affy_u95av2_cel.t
test_affy_u95av2_cel_stream :: pure_all
	PERL_DL_NONLAZY=1 $(FULLPERL) -I$(INST_ARCHLIB) -I$(INST_LIB) -I$(PERL_ARCHLIB) -I$(PERL_LIB) -e 'use Test::Harness qw(&runtests $$verbose); $$verbose=$(TEST_VERBOSE); runtests @ARGV;' t/affy_u95av2_cel_stream.t
